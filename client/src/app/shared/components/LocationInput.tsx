...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const locationUrl = "https://us1.locationiq.com/v1/search?key=pk.d40184673cf03e518cc6e18d6db22c90&limit=5&dedupe=1&format=json&normalize=1&normalizecity=1&addressdetails=1&"
